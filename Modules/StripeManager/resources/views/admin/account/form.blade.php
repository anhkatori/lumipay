...
<div class="card mx-3">
    ...
    <form
        action="{{ isset($stripeAccount) ? route('admin.stripe-accounts.update', $stripeAccount->id) : route('admin.stripe-accounts.store') }}"
        method="POST">
        <div class="card-body p-5">
            ...
            <div class="row">
                <div class="col-12 col-sm-3">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('domain') is-invalid @enderror" id="domain" name="domain"
                            value="{{ old('domain', isset($stripeAccount) ? $stripeAccount->domain : '') }}">
                    </div>
                </div>
                <div class="col-12 col-sm-3">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('max_receive_amount') is-invalid @enderror"
                            ...
                            value="{{ old('max_receive_amount', isset($stripeAccount) ? $stripeAccount->max_receive_amount : '') }}">
                    </div>                
                </div>
                <div class="col-12 col-sm-3">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" step="0.01"
                            ...
                            value="{{ old('max_order_receive_amount', isset($stripeAccount) ? $stripeAccount->max_order_receive_amount : '') }}">
                    </div>
                </div>
                <div class="col-12 col-sm-3">
                    <div class="form-group mb-3">
                ...
                <div class="col-12 col-sm-12 @if(!isset($stripeAccount)) d-none @endif">
                    <div class="form-group mb-3 ">
                        ...
                        <input type="number" step="0.01" class="form-control @error('current_amount') is-invalid @enderror"
                            ...
                            value="{{ old('current_amount', isset($stripeAccount) ? $stripeAccount->current_amount : '0') }}">
                    </div>
                </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('client_ids')is-invalid @enderror" id="client_ids"
                            ...
                            @foreach ($clients as $client)
                                <option value="{{ $client->id }}" {{ isset($stripeAccount) && in_array($client->id, explode(',', $stripeAccount->client_ids)) ? 'selected' : '' }}>
                                    {{ $client->name }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="card-footer p-3 px-5">
            <button type="submit"
                class="float-end btn btn-primary">{{ isset($stripeAccount) ? 'Update Account' : 'Create Account' }}</button>
        </div>
    </form>
</div>
@endsection