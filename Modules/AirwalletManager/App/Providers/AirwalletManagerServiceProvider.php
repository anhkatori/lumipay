...
class AirwalletManagerServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'AirwalletManager';

    protected string $moduleNameLower = 'airwalletmanager';
